...
return [
    ...
    0 => [
        "name" => "K-suke",
        "profile" => "20代のころは飲食でバイトをしながら、バンド活動。
                    30歳を超えてからライティング、サイト作成、プログラミング等をはじめ、
                    今は27歳で覚えた競馬をしながらプログラマとして生きています。
                    子守歌は「浜省」「ブルーハーツ」。
                    バンドはミッシェル,ブランキー、BOOWY,ゴイステ、ブルーハーツ...等を好む。",
        "updateInfo" => [
            [
                "day" => "",
            ...
            [
                "day" => "",
                "contents" => "仕事術,人間関係とか徒然に",
            ],
        ],
        "greeting" => "とにかく毎日ドキドキワクワクしたい！
                        音楽、IT関係、料理、酒、競馬...もちろんそれ以外のことでも、
                        ワクワクしながら生きるのが好きで、偏愛にも似た「自分の好きなもの」を持ったアナタ！と仲良くしたいです。よろしくお願いします。",
