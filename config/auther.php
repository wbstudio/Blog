...
return [
    ...
    0 => [
        "name" => "K-suke",
        "profile" => "20代のころは飲食でバイトをしながら、バンド活動をしていました。
                    30歳を超えてからライティング、サイト作成、プログラミング等をはじめ、
                    今は競馬をしながらプログラマとして食っています。
                    バンドはミッシェル,ブランキー、BOOWY,ゴイステ、ブルーハーツ...等が好きです。",
        "updateInfo" => [
            [
                "day" => "",
                "contents" => "ライティング/ネットビジネス",
            ],
            [
                "day" => "",
                "contents" => "プログラミング/サイト制作",
            ],
            [
                "day" => "",
                "contents" => "競馬",
            ...
            [
                "day" => "",
                "contents" => "仕事術とか人間関係とか徒然なるままに",
            ],
        ],
        "greeting" => "とにかく毎日ドキドキワクワクしたいなと思ってます。
                        音楽、IT関係、料理、酒、競馬...もちろんそれ以外のことでも、
                        ワクワクしながら生きるのが好きで、偏愛にも似た「自分の好きなもの」を持ったアナタ！よろしくお願いします。",
        "imgPath" => "K-suke_face.png",
        "category" => [
            0 => [
                "name" => "ライティング/ネットビジネス",
        ...
        "sns_link" => [
                0 => [
                    "sns_type" => "twitter",
                    "link_type" => "image",
                    "explain" => "00カテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリ",
                    "link_ahead" => "http://new-blog",
                    "link_image" => "Twitter_black.svg",
                ],
                1 => [
                    "sns_type" => "facebook",
                    "link_type" => "image",
                    "explain" => "00カテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリーの説明textカテゴリ",
                    "link_ahead" => "http://google.com",
                    "link_image" => "Facebook_black.svg",
                ],
                2 => [
                    "sns_type" => "ホームページ",
                    "link_type" => "text",
    ...
    4 => [
        "name" => "TETSU-08",
        "profile" => "1985年生まれ。新潟県出身。
                    幼い頃から格闘技、武器、兵器等の類に興味がありました。それ系の公務員に二度就職。
                    その後民間肉体労働を転々とし今に至ります。考えが変化し今は脱肉体労働、自分の趣味と仕事
        ...
        "greeting" => "基本一人行動好きです。当面は体脂肪を減らす事と仕事に必要な資格取得が目標です。
                    ゴルフ、ゲーム、アニメをちょこちょこ嗜みます。
                    ボクシングが好きでタイソン、フレージャー、ロペス等が好きです。よろしくお願いします。",
        "imgPath" => "face_test.png",
        "category" => [
                0 => [
                    "name" => "1ネットビジネス",
